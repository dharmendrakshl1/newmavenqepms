...
$(document).ready(function() 
		{
			...
			$( "#btn_skilltypeadd" ).click(function() {
				...
				$("#technicaldetails table tbody:last").prepend(
						...
						'<a href="javascript:" onclick="$(this).parent().parent().remove(); ui_rows(); return false;"><img src="<c:url value="/resources/images/delete.png"/>" alt="" class="deletetechnicaldetails" align="top" /></a></td>' +
						'</tr>' 
						);
		...
		$( "#btn_educationdetails" ).click(function() {
				...
				if($degree==""||$degree==null||$specialization==null||$specialization==""||$college==null||$college==""||$yearOfPassing==null||$yearOfPassing=="")
					{
      ...
      //var totalExperience = $('#totalExperience').val();
		var totYear= $("#totYear").val();
		var totMon= $("#totMon").val();
// 		document.submitResume.totalExperience.value= totYear+" Years "+totMon+" Months";
	...
	<div id="content">
			...
			<div id="contenPan_main">
				<form:form modelAttribute="resumeDTO" method="post" id="target"
						...
						<div class="TabbedPanelsContentGroup">
							<div class="TabbedPanelsContent">
								...
								<div class="subsection" id="forms">
									<ul>
										<li>
											...
											<div class="fleft">
												<select id="title" title="Select one of the three titles: Miss,Mr,Mrs">
													<option></option>
													<option selected>
											...
											<c:choose>
												<c:when test="${skills.skillCatagory == 'PRIMARY'}">
													<li><span class="mandatory">*</span>
														...
														<div class="fleft"><textarea rows="2" name="OFF" wrap="OFF" title="Enter your primary skills. Eg: Java,C#,webMethods etc"
														cols="5" id="primaryskills"><c:out value="${skills.skill}" /></textarea></div>
								...
								<c:when test="${skills.skillCatagory == 'SECONDARY'}">
									<li><span class="mandatory">*</span>
										...
										<div class="fleft"><textarea rows="2" name="OFF" wrap="OFF" cols="5" title="Enter your secondary skills. Eg: Java,C#,webMethods etc"
										id="secondaryskills"><c:out value="${skills.skill}" /></textarea></div>
							...
							<li><span class="mandatory">*</span>
											...
											<div class="fleft">	</div>
												...
												<input type="hidden" id="totalExperience" name="totalExperience" value="${resume.totalExperience}"/>
										...
										<li><span class="mandatory">*</span>
											...
											<div class="fleft"></div>
												...
												<input type="hidden" id="relevantExperience" name="relevantExperience" value="${resume.relevantExperience}"/> &nbsp; 
													<font style="" class="label"></font>
										...
										<li>
											...
											<div class="fleft">
											<textarea rows="5" cols="14" name="domain" id="domain" title="Enter your project domain and details" 
											style="margin: 0px; width: 282px; height: 103px;">${resume.domain}</textarea>
											 &nbsp;
										</li>

										<li>
											<div class="label">Certifications(if any):</div>
											<div class="fleft">
											<textarea rows="5" cols="14" name="certification" id="certification" 
												title="Enter if you have attended any certification course/exam. "
												style="margin: 0px; width: 282px; height: 103px;">${resume.certification}</textarea>
											</div>
										</li>
					...
					<li><span class="mandatory">*</span>
						...
						<div class="fleft">
							<textarea rows="2" cols="5" name="professionalSummary" id="professionalsummary"
							 title="Summarize your area of expertise in multiple rows." name="OFF" wrap="OFF">${resume.professionalSummary}</textarea>
						</div>
		...
		<div id="technicaldetailserror"></div>
			...
			<div id="technicaldetailsError"></div>
				<table>
					...
					<tbody>
						<tr>
							<td nowrap="nowrap" title="Select one of the skill type or add your own"><input type="text" value="" name=""
							...
							<td><input type="text" id="skillvalue" title="Mention all the values of that particualr skill.   Eg:Scripting languages-->javascript,PHP,ActivePerl etc. " value="" /></td>
						...
						<c:forEach items="${skillList}" var="skills">
							...
							<td><div>
								<span class="editSkill"><c:out value="${skills.skillType}" /></span>
									...
									<a href="javascript:" onclick="$(this).parent().parent().remove(); ui_rows(); return false;"><img src="<c:url value="/resources/images/delete.png"/>" alt=""
		...
		<div id="projectdetailsserror"></div>
			...
			<div id="projectdetailsError"></div>
				<table>
					...
					<tbody>
						<tr>
							<td nowrap="nowrap" title="Enter the client name of the project you have been working."><input type="text" id="txt_clientname"
								value="" name="" class="normal" size="19" /></td>
							<td title="The duration of the project in years and months. Eg: 1 year 2 months"><input type="text" id="txt_duration" value="" /></td>
							<td title="Name of the project."><input type="text" id="txt_projectname" value="" /></td>
							<td  title="Your role in the particular project. Eg: project lead/team member etc."><input type="text" id="txt_role" value="" /></td>
							<td title="Brief of the project. How it worked? and how was it achieved? etc."><textarea rows="5" id="txt_projectbrief" cols="50"><c:out value="" /></textarea></td>
							<td title="Explain your responsibilities and work done in the achievement of the project"><textarea rows="5" id="txt_responsibilities" cols="30"><c:out value="" /></textarea></td>
							<td title="Explain environment on what the project worked on"><textarea rows="5" id="txt_environment" cols="30"><c:out value="" /></textarea></td>
							<td align="center"><input type="button" value="Add"
		...
		<div class="bottombtn">
			<input class="draftform" type="button" value="Save As Draft" /> <input
				class="submitform" type="button" value="Submit" /> <input type="button" value="Cancel" onclick="history.back();" />
		</div>
