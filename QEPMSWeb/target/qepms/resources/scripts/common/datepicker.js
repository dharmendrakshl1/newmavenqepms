...
//******************************************************************************
    ...
    var scwTodayCellBorderColour = '#ff0000';
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #f5f5f5;}'  +
            '/* Drag Handle */'                                         +
            ...
            'td.scwInputDate            {background-color:  #6f6f6f;'   +
                                        'color:             #ffffff;}'  +
            '/* Weekend Day */'                                         +
            'td.scwCellsWeekend         {background-color:  #CCCCCC;'   +
                                        'color:             #ffffff;}'  +
            '/* Day outside the current month */'                       +
            'td.scwCellsExMonth         {background-color:  #dbdbdb;'   +
                                        'color:             #979797;}'  +
            '/* Today selector */'                                      +
            'td.scwNow                  {background-color:  #ececec;'   +
										'font-size:         11px;'      +
                                        'color:             #000000;}'  +
            '/* Clear Button */'                                        +
            'td.scwClear                {padding:           0px;}'      +
            'input.scwClear             {padding:           2px;'       +
										'background:        #c2ddee;'    +
